...
export const ATTACKS = {
  lp: { anim: 'lightPunch', dmg: 4,  range: 1.35, active: [0.07, 0.17], total: 0.30, hitstun: 0.32, blockstun: 0.18, push: 0.35, shove: 0.18, high: true },
  hp: { anim: 'heavyPunch', dmg: 8,  range: 1.45, active: [0.16, 0.30], total: 0.55, hitstun: 0.46, blockstun: 0.26, push: 0.95, shove: 0.30, high: true },
  lk: { anim: 'lightKick',  dmg: 5,  range: 1.62, active: [0.10, 0.22], total: 0.38, hitstun: 0.34, blockstun: 0.20, push: 0.45, shove: 0.20 },
  hk: { anim: 'heavyKick',  dmg: 10, range: 1.75, active: [0.20, 0.36], total: 0.62, hitstun: 0.5,  blockstun: 0.3,  push: 1.4,  shove: 0.4, knockdown: true },
  uppercut: { anim: 'uppercut', dmg: 13, range: 1.2, active: [0.14, 0.28], total: 0.6, hitstun: 0.6, blockstun: 0.3, push: 0.8, shove: 0.3, launch: true, knockdown: true },
  sweep: { anim: 'sweep', dmg: 7, range: 1.7, active: [0.16, 0.3], total: 0.58, hitstun: 0.5, blockstun: 0.28, push: 0.6, shove: 0.25, low: true, knockdown: true },
